...
> 如果你仍然不能忍受不完美的卡片样式，那就专心将他们美化吧。没有什么能阻止它们变得完美，这些完美的卡片可能倍受你的喜爱，但你的学习速度肯定也会降低了。——[完美主义者的增量学习](https://www.yuque.com/supermemo/wiki/il\_for\_perfectionists)
...
> 与其为了增量阅读而扫描纸质书籍和进行OCR，还不如从寻找电子图书开始。在大多数基础知识领域，都有多种学习材料来源。需要扫描的情况越来越少。现在，你甚至可以更挑剔一些，搜索HTML文本来代替PDF材料（以避免将PDF转换为HTML的痛苦）——[导入文章](https://www.yuque.com/supermemo/wiki/hints_and_tips#gj2PV)
